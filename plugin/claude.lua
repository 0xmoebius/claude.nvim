...
local function apply_defaults()
  ...
  -- Thinking blocks: same muted italic as tool lines by default. Users can
  -- override to make thinking visually distinct if they want.
  vim.api.nvim_set_hl(0, "ClaudeThinkingLine", {
    fg = comment_fg(),
    italic = true,
    default = true,
  })
  -- System messages (slash-command output generated by claude.nvim
  -- itself, not by the model). Link to DiagnosticInfo so they're
  -- visually distinct from model prose and tool lines.
  set_hl("ClaudeSystemLine", "DiagnosticInfo")
  set_hl("ClaudeSystemPrefix", "DiagnosticInfo")
